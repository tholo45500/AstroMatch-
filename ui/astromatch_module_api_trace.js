...
async function calculateSelectedTarget() {
  ...
  console.log("ASTROMATCH TRACE — PRIMARY PROFILE", primary);
  console.log("ASTROMATCH TRACE — TARGET PROFILE", target);
  console.log("ASTROMATCH TRACE — PRIMARY API INPUT", primaryInput);
  console.log("ASTROMATCH TRACE — TARGET API INPUT", targetInput);
  ...
  console.log("ASTROMATCH TRACE — API URL", API_URL);
  console.log(
    "ASTROMATCH TRACE — API BODY",
    JSON.stringify({
