...
async function compareOneTarget(primaryChart, targetProfile) {
  ...
  try {
    ...
    const narrative = generateNarrative(interpretation, targetProfile.identity.first_name);
    repository.saveInterpretation(targetProfile.profile_id, { sections: interpretation, narrative });
